...
KNOWN_HEIGHT = 0.32  # height of the object in the same
...
cap.set(3, 1280)
cap.set(4, 720)
model = YOLO("Weights/speed_bumps.pt")

classNames = ['Marked Bump', 'Unmarked Bump']
...
while True:
    ...
    for r in results:
        ...
        for box in boxes:
            ...
            if classNames[cls] == 'Unmarked Bump':  # You can adjust the confidence threshold
                ...
                os.makedirs("image/speed_bump", exist_ok=True)

                # Rest of your code remains the same
                image_filename = f'image/speed_bump/{timestamp}.jpg'
                ...
                detected_objects_collection = db.collection("speed_bump")
